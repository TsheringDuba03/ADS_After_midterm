...
public class SeparateChainingHashST<Key, Value> {
    ...
    public static void main(String[] args) { 
        ...
        System.out.println (st.get("Wangchen"));
         System.out.println (st.get("Kinley"));
          System.out.println (st.get("Tshering"));
           System.out.println (st.get("Apsha"));


        assert(st.isEmpty()==false);

        assert(st.contains("Kinley"));
        

        //System.out.print("All test case pass");
